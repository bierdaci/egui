...
typedef ebool (*eTraverseFunc)(ePointer key, ePointer value, ePointer data);
...
ebool e_tree_lookup_extended  (eTree *tree, ePointer lookup_key, ePointer *orig_key, ePointer *value);
